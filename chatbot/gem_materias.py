    ...
    if url:
        try:
            ...
            if text_content:
                ...
                prompt = f"Analise o seguinte texto jornalístico e forneça uma nota de 0 a 10 com base na qualidade da escrita, clareza e conteúdo informativo: {text_content}"
...
def create_window():
    window = tk.Tk()
    window.title("Análise de Texto Jornalístico com Gemini")

    frame = tk.Frame(window, padx=10, pady=10)
    frame.pack(padx=10, pady=10)

    url_label = tk.Label(frame, text="Insira a URL do texto jornalístico:")
    url_label.pack()
